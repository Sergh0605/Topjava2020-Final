...
#### Apply 9_0_fix.patch
> - Fix + рефакторинг `TestMatcher`. Добавил `@SafeVarargs` и сделал реализацию проверок через [паттерн стратегия](https://refactoring.guru/ru/design-patterns/strategy). 
